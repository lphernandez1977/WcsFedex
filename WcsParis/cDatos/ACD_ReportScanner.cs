...
namespace WcsFedex
{
    public class ACD_ReportScanner
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["cnnString"].ToString()))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("sp_selec_reporte_scanner", con))
                    {
                        ...
                        cmd.Parameters.Add("@in_Fecha_Inicio", System.Data.SqlDbType.VarChar, 10).Value = oFecha;
                        cmd.Parameters.Add("@in_Fecha_Termino", System.Data.SqlDbType.VarChar, 10).Value = oFechaTer;
                        //abrimos conexion
                        con.Open();
        ...
        public DataSet Listado_ReportScannerDiario(string oFecha)
        {
            DataSet ds = new DataSet();
            try
            {
                ...
                {
                    //asignar los valores proporcionados a estos parámetros sobre la base de orden de los parámetros
                    using (SqlCommand cmd = new SqlCommand("SP_INFORME_RESUMEN_DIARIO_LECTURAS_SORTER", con))
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Add("@in_Fecha_Inicio", System.Data.SqlDbType.VarChar, 10).Value = oFecha;
                        //cmd.Parameters.Add("@in_Fecha_Termino", System.Data.SqlDbType.VarChar, 10).Value = oFechaTer;
