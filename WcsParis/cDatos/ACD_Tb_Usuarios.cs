...
namespace WcsFedex
{
    ...
    {
        cRegistroErr ErrorSql = new cRegistroErr();
        ...
        public cTb_Usuarios Selecciona_Usuario(cTb_Usuarios oUser)
        {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["cnnString"].ToString()))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("sp_selec_usuario", con))
                    {
                        ...
                        if (dataReader.HasRows)
                        {
                            ...
                            {
                                {
                                    _cTb_Usuarios.Nom_Usuario = dataReader["Nom_Usuario"].ToString();
                                    _cTb_Usuarios.Nivel = Convert.ToChar(dataReader["Nivel"]);
                                    _cTb_Usuarios.Nom_Nivel = dataReader["NAcceso"].ToString();
                                    _cTb_Usuarios.Mensaje = dataReader["Mensaje"].ToString();
                                }                                
                            }
            ...
            {
                ErrorSql.RegistroLog(ex.Message.ToString());
                return null;
            }
        }
